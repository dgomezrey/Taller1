...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisAtleta(){
		System.out.println("\n" + "Consultar pais que representa u atleta" + "\n");
		String nombreAtleta=input("Ingrese el nombre del atleta a consultar");
		String pais=calculadora.paisAtleta(nombreAtleta);
		System.out.println(nombreAtleta+" representa a: "+pais);
	}
